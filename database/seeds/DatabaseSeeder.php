...
class DatabaseSeeder extends Seeder {
	...
	public function run()
	{
		...
		Post::create([
			'title' => 'Post 1',
			'slug' => 'post-1', 
			'sample' => '<img alt="" src="http://localhost/laravel5_base4/public/filemanager/userfiles/greatredactor/mega-champignon-icone-8453-128.png" style="float:left; height:128px; width:128px" />' . $lipsum->getContent(50),
		...
		Post::create([
			'title' => 'Post 2',
			'slug' => 'post-2', 
			'sample' => '<img alt="" src="http://localhost/laravel5_base4/public/filemanager/userfiles/greatredactor/goomba-icone-7704-128.png" style="float:left; height:128px; width:128px" />' . $lipsum->getContent(50),
...
', 
		...
		Post::create([
			'title' => 'Post 3',
			'slug' => 'post-3', 
			'sample' => '<img alt="" src="http://localhost/laravel5_base4/public/filemanager/userfiles/greatredactor/rouge-shell--icone-5599-128.png" style="float:left; height:128px; width:128px" />' . $lipsum->getContent(50),
			'content' => $lipsum->getContent(500), 
			'active' => true,
			'user_id' => 2
		]);
		...
		Post::create([
			'title' => 'Post 4',
			'slug' => 'post-4', 
			'sample' => '<img alt="" src="http://localhost/laravel5_base4/public/filemanager/userfiles/greatredactor/rouge-shyguy-icone-6870-128.png" style="float:left; height:128px; width:128px" />' . $lipsum->getContent(50),
			'content' => $lipsum->getContent(500), 
			'active' => true,
			'user_id' => 2
		]);
